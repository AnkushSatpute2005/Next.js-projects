        ...
        <div className="support w-1/2 bg-slate-900 rounded-lg p-4">
          ...
          <div className="flex gap-2 flex-col">
            ...
            <input
              ...
              id=""
            />
            <button className='className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"'>
              Pay
            </button>
          </div>
